classdef ExpMIB1 < handle
    ...
    methods
        function obj= ExpMIB1( nick, mode )
            ...
            fname= sprintf( '../ExpData/expMIB_%s.mat', nick );
            if exist( fname, 'file' ),
                obj.data= load(fname);
            else
            ...
            while GetSecs()- start< 10, %20*60,
                obj.presentation.runMIBTrial(  obj.data.betaIdx(obj.data.curBeta), imgIdx );
