classdef groupPM < SquareLattice    
    methods
        function obj= groupPM()
...
%                 end
        ...
        function data= getLocalMirrorSymmetry(obj)
            data= obj.data;
            for k=0:obj.size(2)-1,
                data( :, (obj.baseSize(2):-1:1)+ k*obj.baseSize(2) ) =...
                    data( :, (1:obj.baseSize(2)) + k*obj.baseSize(2) );
            end            
        end
